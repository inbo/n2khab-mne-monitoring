...
GDB.ODStoCSVs(base_folder/"loceval_dev_dbstructure.ods", base_folder/"devdb_structure")

db_connection = GDB.ConnectDatabase(
...
if False:
    ...
    # database: loceval
    base_folder = GDB.PL.Path(".")
    GDB.ODStoCSVs(base_folder/"loceval_dbstructure.ods", base_folder/"db_structure")
