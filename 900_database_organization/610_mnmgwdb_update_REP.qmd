...
sampleunit_characols <- c("grts_address", "stratum") # ERROR location_id was in here ☠
index_column <- mnmgwdb$get_primary_key(table_label)
...
# sampleunits_lookup <- mnmgwdb$query_columns("SampleUnits", c("grts_address", "type", "sampleunit_id"))
...
mnmgwdb$query_table("FieldworkCalendar") %>%
  left_join(
    mnmgwdb$query_table("SampleUnits"),
    by = join_by(grts_address, stratum)
  ) %>%
