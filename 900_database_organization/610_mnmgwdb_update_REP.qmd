...
# TODO it is highly confusing that geometry must be dropped: actually, Locations are a geometry table (Point type) and this should fail for `distribution$to_upload`
