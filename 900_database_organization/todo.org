...
* mnmgwdb
+ tester doesn't consistently get access,
...
+ [ ] gmaps attachment link (Ward/Tom)
  + [ ] show WGS84 coords for car navigation
    + via extra table, linked on location_id
+ [ ] new fields
...
+ [ ] divers: batch, serial; ++ view with non-previously placed
  + [ ] but also a free field
