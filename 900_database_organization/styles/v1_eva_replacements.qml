...
<qgis simplifyMaxScale="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="0" minScale="100000000" maxScale="0" autoRefreshTime="0" simplifyDrawingHints="0" simplifyLocal="1" symbologyReferenceScale="-1" labelsEnabled="1" version="3.44.0-Solothurn" simplifyDrawingTol="1" autoRefreshMode="Disabled" simplifyAlgorithm="0">
  <temporal endField="" fixedDuration="0" endExpression="" startField="" durationField="ogc_fid" limitMode="0" startExpression="" enabled="0" durationUnit="min" accumulate="0" mode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation extrusionEnabled="0" symbology="Line" extrusion="0" zscale="1" binding="Centroid" type="IndividualFeatures" customToleranceEnabled="0" showMarkerSymbolInSurfacePlots="0" zoffset="0" respectLayerSymbol="1" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol name="" clip_to_extent="1" frame_rate="10" type="line" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{ed714cff-6319-4074-a790-0037a79be91c}" locked="0" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" clip_to_extent="1" frame_rate="10" type="fill" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{2f94ce04-167a-4946-b481-65938703c1a5}" locked="0" enabled="1" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{9cd913d8-b5c2-4994-83ce-d11b481e71a1}" locked="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" type="categorizedSymbol" symbollevels="0" attr="is_selected">
    <categories>
      <category value="true" uuid="{49043dae-ff53-4a4c-b377-7b96a86d12c5}" render="true" label="gekozen" symbol="0" type="string"/>
      <category value="NULL" uuid="{c8eef96b-5546-448f-99ed-6bbf3e5ad09a}" render="true" label="niet gekozen" symbol="1" type="NULL"/>
    </categories>
    <symbols>
      <symbol name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{3974369a-302e-452e-814a-ffa45758fc58}" locked="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="128,255,250,255,rgb:0.5019608,1,0.9809262,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
      ...
      <symbol name="1" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{a0fd5791-5a4b-4c10-a283-2d99747d18e9}" locked="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
    ...
    <source-symbol>
      <symbol name="0" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{237f8fbb-5f42-4d38-b69a-672626a756da}" locked="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="227,55,30,255,hsv:0.02055555555555556,0.86691081101701384,0.89169146257724885,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" clip_to_extent="1" frame_rate="10" type="marker" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" id="{eac09aa4-60c6-4eb2-bed2-d9f999aac044}" locked="0" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style tabStopDistanceUnit="Point" multilineHeight="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" forcedItalic="0" fontStrikeout="0" fontLetterSpacing="0" fieldName="replacement_rank" fontSizeUnit="Point" textOpacity="1" textOrientation="horizontal" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontFamily="Open Sans" fontSize="10" fontKerning="1" fontWordSpacing="0" legendString="Aa" namedStyle="Regular" multilineHeightUnit="Percentage" fontUnderline="0" textColor="50,50,50,255,rgb:0.1960784,0.1960784,0.1960784,1" useSubstitutions="0" stretchFactor="100" forcedBold="0" fontItalic="0" blendMode="0" tabStopDistance="80" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" allowHtml="0">
        <families/>
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option name="dualview/previewExpressions" type="List">
        <Option value=" &quot;replacement_rank&quot; || ' - ' ||  &quot;samplelocation_id&quot; " type="QString"/>
        <Option value="&quot;notes&quot;" type="QString"/>
        <Option value=" &quot;replacement_rank&quot; || ' - ' ||  &quot;samplelocation_id&quot; " type="QString"/>
      </Option>
  ...
  <fieldConfiguration>
    ...
    <field name="replacement_id" configurationFlags="NoFlag">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option value="true" name="AllowNull" type="bool"/>
    ...
    <field name="replacement_rank" configurationFlags="NoFlag">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option value="true" name="AllowNull" type="bool"/>
    ...
    <field name="is_selected" configurationFlags="NoFlag">
    ...
    <field name="is_inappropriate" configurationFlags="NoFlag">
      <editWidget type="CheckBox">
        <config>
          <Option type="Map">
            <Option value="false" name="AllowNullState" type="bool"/>
    ...
    <field name="rep_notes" configurationFlags="NoFlag">
    ...
    <field name="unit_notes" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="true" name="IsMultiline" type="bool"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="main_type" name="Group" type="QString"/>
  ...
  <aliases>
    ...
    <alias index="1" name="" field="replacement_id"/>
    <alias index="2" name="" field="sampleunit_id"/>
    <alias index="3" name="GRTS" field="grts_address"/>
    <alias index="4" name="volgorde vervangcandidaten" field="replacement_rank"/>
    <alias index="5" name="gekozen vervanglocatie" field="is_selected"/>
    <alias index="6" name="locatie niet bruikbaar" field="is_inappropriate"/>
    <alias index="7" name="heeft implicaties voor habitatmap" field="implications_habitatmap"/>
    <alias index="8" name="vervanging gedaan" field="is_replaced"/>
    <alias index="9" name="notities vervangcel" field="rep_notes"/>
    <alias index="10" name="notities steekproefeenheid" field="unit_notes"/>
    <alias index="11" name="" field="visit_id"/>
    <alias index="12" name="type (vastgesteld)" field="type_assessed"/>
    <alias index="13" name="bezoek gedaan" field="visit_done"/>
  </aliases>
  <splitPolicies>
    <policy field="ogc_fid" policy="DefaultValue"/>
    <policy field="replacement_id" policy="DefaultValue"/>
    <policy field="sampleunit_id" policy="DefaultValue"/>
    <policy field="grts_address" policy="DefaultValue"/>
    <policy field="replacement_rank" policy="DefaultValue"/>
    <policy field="is_selected" policy="DefaultValue"/>
    <policy field="is_inappropriate" policy="DefaultValue"/>
    <policy field="implications_habitatmap" policy="DefaultValue"/>
    <policy field="is_replaced" policy="DefaultValue"/>
    <policy field="rep_notes" policy="DefaultValue"/>
    <policy field="unit_notes" policy="DefaultValue"/>
  ...
  <defaults>
    ...
    <default expression="" field="replacement_id" applyOnUpdate="0"/>
    <default expression="" field="sampleunit_id" applyOnUpdate="0"/>
    <default expression="" field="grts_address" applyOnUpdate="0"/>
    <default expression="" field="replacement_rank" applyOnUpdate="0"/>
    <default expression="" field="is_selected" applyOnUpdate="0"/>
    <default expression="" field="is_inappropriate" applyOnUpdate="0"/>
    <default expression="" field="implications_habitatmap" applyOnUpdate="0"/>
    <default expression="" field="is_replaced" applyOnUpdate="0"/>
    <default expression="" field="rep_notes" applyOnUpdate="0"/>
    <default expression="" field="unit_notes" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="1" constraints="3" exp_strength="0" notnull_strength="1" field="replacement_id"/>
    ...
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="replacement_rank"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="is_selected"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="is_inappropriate"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="implications_habitatmap"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="is_replaced"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="rep_notes"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="unit_notes"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" notnull_strength="0" field="visit_id"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="replacement_id" exp=""/>
    <constraint desc="" field="sampleunit_id" exp=""/>
    <constraint desc="" field="grts_address" exp=""/>
    <constraint desc="" field="replacement_rank" exp=""/>
    <constraint desc="" field="is_selected" exp=""/>
    <constraint desc="" field="is_inappropriate" exp=""/>
    <constraint desc="" field="implications_habitatmap" exp=""/>
    <constraint desc="" field="is_replaced" exp=""/>
    <constraint desc="" field="rep_notes" exp=""/>
    <constraint desc="" field="unit_notes" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="replacement_id" width="-1" type="field" hidden="0"/>
      <column name="grts_address" width="-1" type="field" hidden="0"/>
      <column name="replacement_rank" width="-1" type="field" hidden="0"/>
      <column name="is_selected" width="-1" type="field" hidden="0"/>
      <column name="is_inappropriate" width="-1" type="field" hidden="0"/>
      <column name="implications_habitatmap" width="-1" type="field" hidden="0"/>
      <column name="sampleunit_id" width="-1" type="field" hidden="0"/>
      <column name="is_replaced" width="-1" type="field" hidden="0"/>
      <column name="rep_notes" width="-1" type="field" hidden="0"/>
      <column name="unit_notes" width="-1" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" collapsedExpressionEnabled="0" visibilityExpression="" name="deze vervangcel" groupBox="0" collapsed="0" columnCount="1" type="Tab" verticalStretch="0" visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="">
      <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
      </labelStyle>
      <attributeEditorField horizontalStretch="0" index="3" name="grts_address" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="4" name="replacement_rank" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="5" name="is_selected" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="6" name="is_inappropriate" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="7" name="implications_habitatmap" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="9" name="rep_notes" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer horizontalStretch="0" collapsedExpressionEnabled="0" visibilityExpression="" name="steekproefeenheid" groupBox="0" collapsed="0" columnCount="1" type="Tab" verticalStretch="0" visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="">
      <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
      </labelStyle>
      <attributeEditorField horizontalStretch="0" index="2" name="sampleunit_id" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="10" name="unit_notes" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="12" name="type_assessed" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="8" name="is_replaced" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="13" name="visit_done" verticalStretch="0" showLabel="1">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont strikethrough="0" style="" description="Cantarell,10,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="implications_habitatmap" editable="1"/>
    <field name="is_inappropriate" editable="1"/>
    <field name="is_replaced" editable="1"/>
    <field name="is_selected" editable="1"/>
    <field name="notes" editable="1"/>
    <field name="ogc_fid" editable="0"/>
    <field name="rep_notes" editable="1"/>
    <field name="replacement_id" editable="0"/>
    <field name="replacement_rank" editable="0"/>
    <field name="samplelocation_id" editable="0"/>
    <field name="sampleunit_id" editable="0"/>
    <field name="type_assessed" editable="1"/>
    <field name="unit_notes" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="is_inappropriate" labelOnTop="0"/>
    <field name="is_replaced" labelOnTop="0"/>
    <field name="is_selected" labelOnTop="0"/>
    <field name="notes" labelOnTop="0"/>
    <field name="ogc_fid" labelOnTop="0"/>
    <field name="rep_notes" labelOnTop="0"/>
    <field name="replacement_id" labelOnTop="0"/>
    <field name="replacement_rank" labelOnTop="0"/>
    <field name="samplelocation_id" labelOnTop="0"/>
    <field name="sampleunit_id" labelOnTop="0"/>
    <field name="type_assessed" labelOnTop="0"/>
    <field name="unit_notes" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="is_inappropriate" reuseLastValue="0"/>
    <field name="is_replaced" reuseLastValue="0"/>
    <field name="is_selected" reuseLastValue="0"/>
    <field name="notes" reuseLastValue="0"/>
    <field name="ogc_fid" reuseLastValue="0"/>
    <field name="rep_notes" reuseLastValue="0"/>
    <field name="replacement_id" reuseLastValue="0"/>
    <field name="replacement_rank" reuseLastValue="0"/>
    <field name="samplelocation_id" reuseLastValue="0"/>
    <field name="sampleunit_id" reuseLastValue="0"/>
    <field name="type_assessed" reuseLastValue="0"/>
    <field name="unit_notes" reuseLastValue="0"/>
    <field name="visit_done" reuseLastValue="0"/>
    <field name="visit_id" reuseLastValue="0"/>
  </reuseLastValue>
