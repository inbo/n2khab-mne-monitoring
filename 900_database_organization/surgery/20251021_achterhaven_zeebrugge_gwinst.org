...
20251022 append local replacement
#+begin_src sql
UPDATE "outbound"."FieldworkCalendar"
SET archive_version_id = NULL
WHERE grts_address IN (29769397)
AND archive_version_id = 3
;
#+end_src
...
1195701, 122549, 1588917, 212661, 253621, 3202741, 3554997, 3858101, 409269, 44961461, 450229, 48053941, 48578229, 49692341, 5193397, 5234357, 540341, 5455541, 5979829, 908981, 4447925, 19914421
)
;
