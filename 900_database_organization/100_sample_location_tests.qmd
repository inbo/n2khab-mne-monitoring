...
```{r load-fag-grts-calender-shortterm-attribs-sf}
...
# glimpse(fag_grts_calendar_shortterm_attribs_sf)

knitr::kable(head(
  sf::st_drop_geometry(fag_grts_calendar_shortterm_attribs_sf)
))
```
...
```{r upload-calendar}
location_calendar <- fag_grts_calendar_shortterm_attribs_sf %>% 
    mutate(
