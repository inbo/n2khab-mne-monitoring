...
```{r mhqpolygons-locations}
#| eval: true
#| echo: false

check_foreignkey_connection(
  table_label = "MHQPolygons", fk = "location_id",
  characteristic_columns = c("grts_address"),
  ref_table = "Locations", pk = "location_id"
)
...
## Field Calendar, Visits, and Observations
...
```{r observations-visits}
#| eval: true
#| echo: false

check_foreignkey_connection(
  table_label = "Observations", fk = "visit_id",
  characteristic_columns = c("grts_address"),
  ref_table = "Visits" 
)
