...
ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN date_first_visit date DEFAULT NULL; 
...
ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_freewater_1 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_freewater_1 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_freewater_2 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_freewater_2 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_freewater_3 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_freewater_3 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_sample_1 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_sample_1 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_sample_2 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_sample_2 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_a_sample_3 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_a_sample_3 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_b_sample_1 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_b_sample_1 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_b_sample_2 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_b_sample_2 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN torch_b_sample_3 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".torch_b_sample_3 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_a_sample_1 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_a_sample_1 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_a_sample_2 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_a_sample_2 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_a_sample_3 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_a_sample_3 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_b_sample_1 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_b_sample_1 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_b_sample_2 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_b_sample_2 IS E'(repeated measurements)';

ALTER TABLE "inbound"."ChlorophyllMeasurements" ADD COLUMN fluo_b_sample_3 double precision; 
COMMENT ON COLUMN "inbound"."ChlorophyllMeasurements".fluo_b_sample_3 IS E'(repeated measurements)';
