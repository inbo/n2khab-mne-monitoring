...
within_radius <- function(x, y, r = 100) {
  dist <- euclid(
    nonnan(x) - nanmean(x),
    nonnan(y) - nanmean(y)
  )
...
sel <- within_radius(px, py, r = 96) # TODO
...
print(nanmean(dx[sel]))
print(nanmean(dy[sel]))
```


TODO idea: slope-weighted average direction
