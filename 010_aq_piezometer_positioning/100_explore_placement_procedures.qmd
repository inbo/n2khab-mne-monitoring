...
calculate_flow_direction <- function(
  ...
  crs(coarse_grid) <- "EPSG:31370"
  coarse_raster <- resample(location_raster, coarse_grid,
  ...
  sel <- within_radius(px, py, r = margin-flow_cellsize) 
  ...
  flow_vector <- c(nancumsum(dx, slope, sel), nancumsum(dy, slope, sel))
