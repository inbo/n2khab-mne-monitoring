...
*Disambiguation:* This is about server system users; for postgresql user roles, *cf.* [[authentication]]
...
- It is locked, but can be accessed by first switching to root user, and successively switching to the database user:
	...
	su - postgres
	```
- This is needed for #database/creation and to handle [user roles]([[authentication]]).