...
Recording #Observations in the field is more or less mandatory, depending on current workload and (changing) decisions by the coordinating colleagues.
Therefore, Observations are optionally linked to Visits, which is explained in detail here: [[sql/optional link of Observations and Visits|optional link of Observations and Visits]].
