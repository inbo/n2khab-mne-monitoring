...
R Script which **defines an object** to facilitate connection to the [[database|databases]].
...
distinction: [[MNMDatabaseToolbox]] is a collection of procedures that work on the connection object
## Conventions:
