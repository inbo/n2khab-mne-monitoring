...
this is an attempt to improve usability of the database in [[R/R]] by wrapping common methods into one object-like list
see <https://github.com/inbo/n2khab-mne-monitoring/blob/main/900_database_organization/MNMDatabaseConnection.R>
